...
$(function() {
	...
	var root = $('.masthead-title > a').attr('href'),
	...
	if($("#overlay").length){
	    ...
	    $(this).html('<i class="icon-remove fa fa-compress icon-white"> </i> Close');
		...
		$("#overlay .expandcode").html('<i class="icon-fullscreen fa fa-expand"> </i> Fullscreen');
